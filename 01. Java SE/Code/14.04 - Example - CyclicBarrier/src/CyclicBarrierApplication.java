...
public class CyclicBarrierApplication {
    ...
    public static void main(String[] args) {
        ...
        CyclicBarrier startSignal = new CyclicBarrier(NUMBER_OF_SPRINTERS, new StartSignalDelay());
        ExecutorService executorService = Executors.newFixedThreadPool(NUMBER_OF_SPRINTERS);
